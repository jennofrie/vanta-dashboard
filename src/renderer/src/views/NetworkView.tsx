...
export function NetworkView() {
  ...
  const selDevice = devices.find((d) => d.mac === sel?.id) ?? null
        ...
        <div className="card">
          <div className="card-head">
            <div>
              ...
              <div className="card-sub">{NODES.length} nodes · {EDGES.length} edges</div>
            </div>
          ...
          <div className="map topo-map">
            ...
            <div className="map-info">{loading ? 'Scanning your network…' : `${EDGES.length} paths`}</div>
          </div>
        </div>
        ...
        <div className="card">
          <div className="card-head">
            <div>
              ...
              <div className="card-sub">{NODES.length} total</div>
            </div>
          ...
          <div style={{ marginTop: 16, padding: 14, borderRadius: 10, background: "var(--bg-2)", border: "1px solid var(--border)" }}>
            {sel ? (
              ...
              <div className="card-sub">Select a node</div>
            )}
          </div>
        </div>
      </div>
